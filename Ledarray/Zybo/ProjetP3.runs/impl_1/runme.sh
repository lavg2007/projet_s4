...
HD_PWD='C:/Users/Francois Gauthier/Desktop/Ledarray/ProjetP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Master.tcl -notrace
