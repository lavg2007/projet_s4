...
*/
#define BIN1_SetHigh()          LATEbits.LATE9 = 1
/**
  @Summary
...
*/
#define BIN1_SetLow()           LATEbits.LATE9 = 0
/**
  @Summary
...
*/
#define BIN1_Toggle()           LATEbits.LATE9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE9
    postValue = BIN1_GetValue();
    </code>

*/
#define BIN1_GetValue()         PORTEbits.RE9
/**
  @Summary
  ...
  @Example
    ...
    BIN1_SetDigitalInput();
    </code>

*/
#define BIN1_SetDigitalInput()  TRISEbits.TRISE9 = 1
/**
  @Summary
  ...
  @Example
    ...
    BIN1_SetDigitalOutput();
    </code>

*/
#define BIN1_SetDigitalOutput() TRISEbits.TRISE9 = 0
